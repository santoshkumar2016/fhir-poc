      ...
      <component>
        <structuredBody>
                          ...
                          <xsl:for-each select="$allergies">
                            <xsl:element name="tr">
                              ...
                              <xsl:element name="td">
                                ...
                                <xsl:if test="./Reaction/Name != ''">
                                  <xsl:value-of select="./Reaction/Name"/>
                                </xsl:if>
                              </xsl:element>
                              <xsl:element name="td">
                                <xsl:attribute name="ID">
                                ...
                                <entryRelationship typeCode="MFST" inversionInd="true">
                                  <observation classCode="OBS" moodCode="EVN">
                                    ...
                                    <value xsi:type="CD" codeSystem="2.16.840.1.113883.6.96">
                                      ...
                                      <xsl:attribute name="code">
                                        <xsl:value-of select="./*[local-name()='Reaction' and namespace-uri()='']/*[local-name()='Code' and namespace-uri()='']"/>
                                      </xsl:attribute>
                                    </value>
          ...
          <!--
            ...
            ********************************************************
            -->
          <xsl:variable name="problems" select="//Patient/Problems"/>
                        ...
                        <tbody>
                          <xsl:for-each select="$problems">
                            ...
                            <tr>
                              ...
                              <td>
                                <xsl:value-of select="normalize-space(./ExpirationDate/text())"/>
                              </td>
                              <td>
                                <xsl:value-of select="normalize-space(./Status/text())"/>
                              </td>
                    ...
                    <xsl:for-each select="$problems">
                      ...
                      <entry typeCode="DRIV">
                        <act classCode="ACT" moodCode="EVN">
                          ...
                          <xsl:choose>
                            <xsl:when test="normalize-space(./Status/text())!=''">
                              <xsl:element name="statusCode">
                                <xsl:attribute name="code">
                                  <xsl:value-of select="translate(normalize-space(./Status/text()), $uppercase, $smallcase)" />
                                </xsl:attribute>
                              </xsl:element>
                            </xsl:when>
                            <xsl:otherwise>
          ...
          <!--
            ...
            ********************************************************
            -->
          <xsl:if test="count(//Immunizations) &gt; 0">
            <component>
              <xsl:choose>
                  ...
                  <section>
                    ...
                    <text>
                      <table border="1" width="100%">
                        ...
                        <tbody>
                          <xsl:for-each select="//Patient/Immunizations">
                            <tr>
                              <td>
                                <content ID="immun1">
                                  <xsl:attribute name="ID">
                          ...
                          <consumable>
                            <manufacturedProduct classCode="MANU">
                              ...
                              <xsl:variable name="immzcode">
                                <xsl:choose>
                                  <xsl:when test="string-length(normalize-space(./Code/text())) = 1">
                                    <xsl:value-of select="concat('0',normalize-space(./Code/text()))"/>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <xsl:value-of select="normalize-space(./Code/text())"/>
                                  </xsl:otherwise>
