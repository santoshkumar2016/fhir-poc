...
// default package
// Generated Dec 29, 2016 12:38:12 PM by Hibernate Tools 4.0.0.Final
...
@DynamicUpdate(true)
@Table(name = "oauth_client_details", catalog = "qrda")
public class OauthClientDetailsEn implements java.io.Serializable {
	...
	public OauthClientDetailsEn() {
	}

	public OauthClientDetailsEn(String clientId) {
		this.clientId = clientId;
	}

	public OauthClientDetailsEn(String clientId, String resourceIds, String clientSecret, String scope,
